function reply=AskNoEnter(window,message,textColor,bgColor,replyFun,rectAlign1,rectAlign2,fontsize)
% The regular ask function but does not require enter with getchar
